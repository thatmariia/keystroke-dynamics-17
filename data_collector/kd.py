...
PASSWORD = "jAE0c-n1Lpi!"
NR_PASSWORD_ENTRIES = 50
...
class Recorder:
    ...
    def thankyou_screen(self):
        ...
        lbl_contact1 = Label(self.window, text = "You should now see 2 excel files and 1 json. When you have completed all your sessions, please send them via WhatsApp to +31643850097 or email to m.turchina@student.tue.nl", font = ("Arial Bold", 15), wraplength = frame_width)
